...
<style>
  ...
  *{box-sizing:border-box} html,body{margin:0;padding:0}
  ...
  .pubs .ptitle{color:var(--ink);font-size:1.08rem;margin:3px 0 2px;font-weight:600} .pubs .ptitle a{color:inherit;text-decoration:none;border-bottom:1px solid var(--amber)} .pubs .ptitle a:hover{color:var(--amber-deep)} .pubs .auth{color:var(--muted);font-size:.94rem}
  ...
  @media (max-width:925px){
    ...
    header.hero{padding:34px 20px 24px}
    .portrait{width:136px;height:136px;margin-bottom:18px;padding:5px}
    .eyebrow{font-size:11px;letter-spacing:.12em;margin-bottom:10px}
    header.hero h1{font-size:clamp(2rem,11vw,2.8rem);line-height:1.04}
    .role{font-size:1rem;line-height:1.5;max-width:34ch;margin-top:12px}
    .band{grid-template-columns:1fr 1fr;height:164px}
    .band figure{height:164px}
    .band figure + figure{border-left:1px solid rgba(238,237,229,.1);border-top:none}
    ...
    .sec-label{font-size:11.5px;letter-spacing:.14em;margin-bottom:7px}
    .major-label,.contact-label{font-size:12px}
    h2{font-size:1.65rem;line-height:1.15;margin-bottom:12px}
    p{font-size:16.5px;line-height:1.62;margin:0 0 14px}
    p.lead{font-size:1.12rem;line-height:1.5;margin-bottom:16px}
    .row,.row.rev,.seedlearn{grid-template-columns:1fr;gap:18px}
    .row{padding:28px 0}
    .row.rev .txt{order:0}
    .tag{font-size:10.5px;letter-spacing:.1em}
    .row h3{font-size:1.3rem;line-height:1.18;margin:5px 0 11px}
    .row .txt p{font-size:16.5px;line-height:1.6;margin-bottom:13px}
    .txt > .sb{display:none}
    .figs{position:static;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}
    .mobile-sb{display:block;margin-top:0}
    .figs figure:first-child:nth-last-child(1){grid-column:1 / -1}
    figure img{border-radius:10px}
    figure.photo img{height:145px}
    figure.chart img{max-height:230px;padding:3px}
    figcaption{font-size:8.5px;line-height:1.35;margin-top:5px;letter-spacing:.025em}
    .pubs li{padding:13px 0}
    .pubs .venue{font-size:9.5px}
    .pubs .ptitle{font-size:1rem;line-height:1.35}
    .pubs .auth{font-size:.9rem;line-height:1.45}
    .btn{width:100%;justify-content:center;margin-top:18px;padding:12px 16px;border-radius:8px;font-size:10.5px;line-height:1.3;text-align:center}
    .seedlearn{padding:16px;border-radius:14px;background:var(--panel);border:1px solid var(--line);box-shadow:0 12px 28px rgba(41,49,44,.07)}
    .seedlearn img{border-radius:10px}
    .contact{font-size:13px;gap:10px 18px}
    footer{padding:28px 18px 42px;font-size:9.5px;line-height:1.5}
  }
  @media (max-width:520px){
    .wrap{padding:0 16px}
    .brand{font-size:.86rem}
    header.hero{padding:28px 18px 22px}
    .portrait{width:120px;height:120px}
    .role{max-width:31ch}
    .band{height:142px}
    .band figure{height:142px}
    .figs{grid-template-columns:1fr}
    figure.photo img{height:190px}
    figure.chart img{max-height:260px}
  }
</style>
...
<main class="wrap">
  ...
  <section id="research">
    ...
    <div class="row rev">
      ...
      <div class="sb mobile-sb"></div>
    </div>
  </section>
  <section id="pubs">
    <p class="sec-label">Selected publications</p>
    <ul class="pubs">
      <li><div class="venue">Journal of Ecology · 2026</div><div class="ptitle"><a href="https://doi.org/10.1111/1365-2745.70262" target="_blank" rel="noopener">Integrated demographic strategies are more strongly associated with variation in conspecific density dependence than single traits in tropical tree seedlings</a></div><div class="auth">Huanca-Nunez, N., Browne, L., Hülsmann, L., Dent, D.H., Rüger, N., Comita, L.S.</div></li>
      <li><div class="venue">Plants · 2024 · Cover article</div><div class="ptitle"><a href="https://doi.org/10.3390/plants13172378" target="_blank" rel="noopener">Trait-mediated variation in seedling performance in Costa Rican successional forests</a></div><div class="auth">Huanca-Nunez, N., Chazdon, R.L., Russo, S.E.</div></li>
      <li><div class="venue">Journal of Applied Ecology · 2023</div><div class="ptitle"><a href="https://doi.org/10.1111/1365-2664.14531" target="_blank" rel="noopener">Effects of large mammals on seedling communities depend on successional stage and species&#39; strategies</a></div><div class="auth">Huanca-Nunez, N., Chazdon, R., Russo, S.E.</div></li>
      <li><div class="venue">Ecology · 2021</div><div class="ptitle"><a href="https://doi.org/10.1002/ecy.3362" target="_blank" rel="noopener">Seed rain–successional feedbacks in regenerating tropical forests</a></div><div class="auth">Huanca-Nunez, N., Chazdon, R., Russo, S.E.</div></li>
    </ul>
  ...
  <section id="contact" style="border-bottom:none">
    ...
    <div class="contact"><a href="mailto:nohemi.huanca@yale.edu">Email</a><a href="https://scholar.google.com/citations?user=cp5OMEIAAAAJ&hl=en&oi=ao" target="_blank" rel="noopener">Google Scholar</a><a href="https://orcid.org/0000-0002-4603-827X" target="_blank" rel="noopener">ORCID</a><a href="https://www.linkedin.com/in/drnohemihuanca/" target="_blank" rel="noopener">LinkedIn</a><a href="https://github.com/nohemihuanca" target="_blank" rel="noopener">GitHub</a></div>
  </section>
</main>
