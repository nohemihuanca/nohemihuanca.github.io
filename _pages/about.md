...
<style>
  ...
  *{box-sizing:border-box} html,body{margin:0;padding:0}
  ...
  nav.top .r{display:flex;align-items:center;justify-content:space-between;max-width:920px;margin:0 auto;padding:13px 30px}
  ...
  .links{display:flex;gap:14px;align-items:center;font-family:var(--mono);font-size:10.5px;letter-spacing:.06em;text-transform:uppercase;white-space:nowrap}
  ...
  section{padding:54px 0;border-bottom:1px solid var(--line-2)}
